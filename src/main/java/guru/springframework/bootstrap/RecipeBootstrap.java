 ...
 *
 * The overridden "onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent)" method will be triggered by Spring
 * automatically, when the context is refreshed.
