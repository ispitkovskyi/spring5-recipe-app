...
public class IndexControllerTest {
    ...
    /**
     * Spring MockMVC introduction
     * standaloneSetup() - builder, which does NOT bring the Spring context, so test remains a "unit" test (lite-weight)
     * webAppContextSetup() - builder, which brings up the Spring context, so test is not a "unit" test anymore (heavier)
     */
    @Test
